...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <input type="text" name="nombre" required class="form-control" placeholder="Nombre" value="{{ $persona->nombre }}">
    </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <input type="text" name="direccion" class="form-control" placeholder="Dirección" value="{{ $persona->direccion }}" placeholder="Dirección">
            </div>
                </div>
